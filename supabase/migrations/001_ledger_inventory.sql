-- Ledger-based inventory: suppliers, items, receipts, receipt items, stocks, transactions
...
-- Moving average: new_avg = ((old_qty * old_avg) + (new_qty * new_unit_price)) / (old_qty + new_qty)
